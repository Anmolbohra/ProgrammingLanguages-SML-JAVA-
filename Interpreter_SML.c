(*val inputFile= "C:\\Users\\anmol\\Desktop\\input.txt";
val outputFile= "C:\\Users\\anmol\\Desktop\\output.txt";
*)
...
let
 ...
 in
   ( if Real.==(realnum,realtest) then true
 else false)
end
in
...
fun interpreter(inputFile : string, outputFile : string) =
let
